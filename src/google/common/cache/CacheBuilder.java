...
import google.common.base.Suppliers;
import google.common.base.Ticker;
import google.common.cache.AbstractCache.SimpleStatsCounter;
import google.common.cache.AbstractCache.StatsCounter;
import google.common.cache.LocalCache.Strength;
...
/**
 * <p>A builder of {@link LoadingCache} and {@link google.common.cache.Cache} instances having any combination of the
 * following features:
 *
 * <ul>
 ...
 * <li>keys automatically wrapped in {@linkplain java.lang.ref.WeakReference weak} references
 * <li>values automatically wrapped in {@linkplain java.lang.ref.WeakReference weak} or
 *     {@linkplain java.lang.ref.SoftReference soft} references
 ...
 * {@link java.util.concurrent.ConcurrentHashMap}. It implements all optional operations of the {@link LoadingCache} and
 * {@link google.common.cache.Cache} interfaces. The {@code asMap} view (and its collection views) have <i>weakly
 ...
 * cache modification, on occasional cache accesses, or on calls to {@link google.common.cache.Cache#cleanUp}. Expired
 * entries may be counted in {@link google.common.cache.Cache#size}, but will never be visible to read or write
 * operations.
 *
 ...
 * {@link google.common.cache.Cache#cleanUp}; such entries may be counted in {@link google.common.cache.Cache#size}, but will never be
 ...
 * writes. The {@link google.common.cache.Cache#cleanUp} method of the returned cache will also perform maintenance, but
...
public final class CacheBuilder<K, V> {
   ...
   *
   * <p>By default, the cache uses {@link google.common.base.Equivalence#identity} to determine key equality when
   * {@link #weakKeys} is specified, and {@link google.common.base.Equivalence#equals()} otherwise.
   */
   ...
   *
   * <p>By default, the cache uses {@link google.common.base.Equivalence#identity} to determine value equality when
   * {@link #weakValues} or {@link #softValues} is specified, and {@link google.common.base.Equivalence#equals()}
   * otherwise.
   */
   ...
   * configuring a {@code CacheBuilder} and building your {@link google.common.cache.Cache} all in a single statement.
   *
   ...
   *
   * <p>Entries with keys that have been garbage collected may be counted in {@link google.common.cache.Cache#size},
   ...
   *
   * <p>Entries with values that have been garbage collected may be counted in {@link google.common.cache.Cache#size},
   * but will never be visible to read or write operations; such entries are cleaned up as part of
   * the routine maintenance described in the class javadoc.
   *
   * @throws IllegalStateException if the value strength was already set
   ...
   * change.
   *
   * <p>Expired entries may be counted in {@link google.common.cache.Cache#size}, but will never be visible to read or
   ...
   * on the collection-views of {@link google.common.cache.Cache#asMap}.
   *
   * <p>When {@code duration} is zero, this method hands off to
   * {@link #maximumSize(long) maximumSize}{@code (0)}, ignoring any otherwise-specificed maximum
   * size or weight. This can be useful in testing, or to disable caching temporarily without a code
   ...
   * {@link google.common.cache.Cache#stats} will return zero for all statistics. Note that recording stats requires
