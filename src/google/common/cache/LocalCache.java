...
import static google.common.cache.CacheBuilder.NULL_TICKER;
import static google.common.cache.CacheBuilder.UNSET_INT;
...
import google.common.base.Stopwatch;
...
import google.common.cache.CacheBuilder.NullListener;
import google.common.cache.CacheBuilder.OneWeigher;
import google.common.cache.CacheLoader.InvalidCacheLoadException;
import google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import google.common.collect.AbstractSequentialIterator;
import google.common.collect.ImmutableMap;
import google.common.collect.Iterators;
import google.common.collect.Maps;
import google.common.collect.Sets;
import google.common.primitives.Ints;
import google.common.util.concurrent.ExecutionError;
import google.common.util.concurrent.Futures;
import google.common.util.concurrent.ListenableFuture;
import google.common.util.concurrent.ListeningExecutorService;
import google.common.util.concurrent.MoreExecutors;
import google.common.util.concurrent.SettableFuture;
import google.common.util.concurrent.UncheckedExecutionException;
import google.common.util.concurrent.Uninterruptibles;
...
/**
 * The concurrent hash map implementation built by {@link google.common.cache.CacheBuilder}.
 *
 * <p>This implementation is heavily derived from revision 1.96 of <a
 * href="http://tinyurl.com/ConcurrentHashMap">ConcurrentHashMap.java</a>.
 *
 * @author Charles Fry
 * @author Bob Lee ({@code google.common.collect.MapMaker})
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.cache.LocalCache.Segment#newEntry} directly.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.cache.LocalCache.Segment#copyEntry} directly.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.cache.LocalCache.Segment#setValue} instead.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.cache.LocalCache.Segment#getLiveValue}
   * instead.
   */
  @VisibleForTesting
   ...
   * loading, or expired. Unlike {@link google.common.cache.LocalCache.Segment#getLiveValue} this method does not attempt to
  ...
  static class Segment<K, V> extends ReentrantLock {
     ...
     * google.common.cache.LocalCache#containsValue} directly.
     */
    @VisibleForTesting
  ...
  /**
   * Returns the result of calling {@link google.common.cache.CacheLoader#loadAll}, or null if {@code loader} doesn't
