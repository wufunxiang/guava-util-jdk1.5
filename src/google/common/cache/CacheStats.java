...
/**
 * Statistics about the performance of a {@link google.common.cache.Cache}. Instances of this class are immutable.
 *
 ...
 * <li>No stats are modified by operations invoked on the {@linkplain google.common.cache.Cache#asMap asMap} view of
 *     the cache.
 * </ul>
 *
 * @author Charles Fry
...
public final class CacheStats {
  ...
  /**
   * Returns the number of times {@link google.common.cache.Cache} lookup methods have returned either a cached or
  ...
  /**
   * Returns the number of times {@link google.common.cache.Cache} lookup methods have returned a cached value.
   */
  ...
  /**
   * Returns the number of times {@link google.common.cache.Cache} lookup methods have returned an uncached (newly
   * loaded) value, or null. Multiple concurrent calls to {@link google.common.cache.Cache} lookup methods on an absent
  ...
  /**
   * Returns the total number of times that {@link google.common.cache.Cache} lookup methods attempted to load new
  ...
  /**
   * Returns the number of times {@link google.common.cache.Cache} lookup methods have successfully loaded a new value.
  ...
  /**
   * Returns the number of times {@link google.common.cache.Cache} lookup methods threw an exception while loading a
   ...
   * {@linkplain google.common.cache.Cache#invalidate invalidations}.
   */
