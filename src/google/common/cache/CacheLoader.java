...
public abstract class CacheLoader<K, V> {
   ...
   * {@link google.common.cache.CacheBuilder#refreshAfterWrite}, or through a call to {@link LoadingCache#refresh}.
   *
   ...
   * {@link google.common.cache.CacheBuilder#refreshAfterWrite}.
   *
   ...
   * @return a cache loader that loads values by calling {@link google.common.base.Supplier#get}, irrespective of the
   *     key
   */
  @Beta
  ...
  /**
   * Thrown to indicate that an invalid response was returned from a call to {@link google.common.cache.CacheLoader}.
   *
   * @since 11.0
   */
