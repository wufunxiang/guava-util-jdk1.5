...
import static google.common.collect.Iterables.transform;
...
/**
 * Utilities for working with {@link java.lang.reflect.Type}.
 *
 * @author Ben Yu
 */
final class Types {
  ...
  /** Decides what owner type to use for constructing {@link java.lang.reflect.ParameterizedType} from a raw class. */
  ...
  /** Returns a new {@link java.lang.reflect.WildcardType} with {@code upperBound}. */
  @VisibleForTesting static WildcardType subtypeOf(Type upperBound) {
    return new WildcardTypeImpl(new Type[0], new Type[] { upperBound });
  }

  /** Returns a new {@link java.lang.reflect.WildcardType} with {@code lowerBound}. */
