...
public final class InternetDomainName {
  ...
  /**
   * Returns an instance of {@link google.common.net.InternetDomainName} after lenient
  ...
  /**
   * Helper method for {@link #validateSyntax(java.util.List)}. Validates that one part of
