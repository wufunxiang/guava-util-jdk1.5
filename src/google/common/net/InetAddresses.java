...
/**
 * Static utility methods pertaining to {@link java.net.InetAddress} instances.
 *
 ...
 * malformed string.
 *
 * <p>When dealing with {@link java.net.Inet4Address} and {@link java.net.Inet6Address}
 ...
 * address: all "mapped" addresses return {@link java.net.Inet4Address} objects.
 *
...
public final class InetAddresses {
  ...
  /**
   * Returns an {@link java.net.Inet4Address}, given a byte array representation of the IPv4 address.
   *
   * @param bytes byte array representing an IPv4 address (should be of length 4)
   * @return {@link java.net.Inet4Address} corresponding to the supplied byte array
   * @throws IllegalArgumentException if a valid {@link java.net.Inet4Address} can not be created
   */
  ...
  /**
   * Returns the {@link java.net.InetAddress} having the given string representation.
   *
   ...
   *
   * {@link java.net.InetAddress#getByAddress} is documented as throwing a checked
  ...
  /**
   * Returns the string representation of an {@link java.net.InetAddress}.
   *
   * <p>For IPv4 addresses, this is identical to
   * {@link java.net.InetAddress#getHostAddress()}, but for IPv6 addresses, the output
   ...
   * include a Scope ID.
   *
   * @param ip {@link java.net.InetAddress} to be converted to an address string
  ...
  /**
   * Returns the string representation of an {@link java.net.InetAddress} suitable
   * for inclusion in a URI.
   *
   * <p>For IPv4 addresses, this is identical to
   * {@link java.net.InetAddress#getHostAddress()}, but for IPv6 addresses it
   ...
   *
   * <p>Use of either {@link google.common.net.InetAddresses#toAddrString},
   * {@link java.net.InetAddress#getHostAddress()}, or this method is recommended over
   * {@link java.net.InetAddress#toString()} when an IP address string literal is
   * desired.  This is because {@link java.net.InetAddress#toString()} prints the
   * hostname and the IP address string joined by a "/".
   *
   * @param ip {@link java.net.InetAddress} to be converted to URI string literal
   ...
   *
   * <p>This function is similar to {@link google.common.net.InetAddresses#forString(String)},
   * however, it requires that IPv6 addresses are surrounded by square brackets.
   *
   * <p>This function is the inverse of
   * {@link google.common.net.InetAddresses#toUriString(java.net.InetAddress)}.
   *
   ...
   * {@link java.net.Inet6Address#isIPv4CompatibleAddress} in that it more
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded IPv4 compatible address format
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for an embedded IPv4 address
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for 6to4 address format
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded IPv4 in 6to4 address
   * @return {@link java.net.Inet4Address} of embedded IPv4 in 6to4 address
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for Teredo address format
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded Teredo information
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for ISATAP address format
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded IPv4 in ISATAP address
   * @return {@link java.net.Inet4Address} of embedded IPv4 in an ISATAP address
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded IPv4 client address
   ...
   *
   * @param ip {@link java.net.Inet6Address} to be examined for embedded IPv4 client address
   * @return {@link java.net.Inet4Address} of embedded IPv4 client address
   ...
   * {@link java.net.InetAddress} automatically collapses mapped addresses to IPv4.
   * (It is actually possible to avoid this using one of the obscure
   * {@link java.net.Inet6Address} methods, but it would be unwise to depend on such
   ...
   *
   * @param ip {@link java.net.InetAddress} to "coerce"
   * @return {@link java.net.Inet4Address} represented "coerced" address
   * @since 7.0
   */
   ...
   * collection of real {@link java.net.InetAddress}es.  They cannot be used as
   * real addresses for the purposes of network communication.
   *
   * @param ip {@link java.net.InetAddress} to convert
   ...
   * @return {@link java.net.Inet4Address} equivalent of the argument
   */
   ...
   * (the opposite of what {@link java.net.InetAddress#getByAddress} expects).
   *
