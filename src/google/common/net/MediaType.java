...
import static google.common.base.CharMatcher.ASCII;
import static google.common.base.CharMatcher.JAVA_ISO_CONTROL;
import static google.common.base.Charsets.UTF_8;
...
import google.common.base.CharMatcher;
...
import google.common.collect.ImmutableListMultimap;
import google.common.collect.ImmutableMap;
import google.common.collect.ImmutableMultiset;
import google.common.collect.ImmutableSet;
import google.common.collect.Iterables;
import google.common.collect.Maps;
import google.common.collect.Multimap;
import google.common.collect.Multimaps;
...
public final class MediaType {
   ...
   * @throws java.nio.charset.IllegalCharsetNameException if a charset value is present, but illegal
   * @throws java.nio.charset.UnsupportedCharsetException if a charset value is present, but no support is available
   ...
   * when using a {@link java.nio.charset.Charset} object.
   *
   ...
   * {@code charset} parameter set to the {@link java.nio.charset.Charset#name name} of the given charset. Only one
   ...
   * representable as a {@link java.nio.charset.Charset} instance, use {@link #withParameter}.
   */
