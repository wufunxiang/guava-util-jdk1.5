...
public final class Uninterruptibles {
  ...
  /**
   * Invokes {@code latch.}{@link java.util.concurrent.CountDownLatch#await() await()}
   * uninterruptibly.
   */
  ...
  /**
   * Invokes
   * {@code latch.}{@link java.util.concurrent.CountDownLatch#await(long, java.util.concurrent.TimeUnit)
  ...
  /**
   * Invokes {@code future.}{@link java.util.concurrent.Future#get() get()} uninterruptibly.
   * To get uninterruptibility and remove checked exceptions, see
   * {@link google.common.util.concurrent.Futures#getUnchecked}.
   *
   * <p>If instead, you wish to treat {@link InterruptedException} uniformly
   * with other exceptions, see {@link google.common.util.concurrent.Futures#get(java.util.concurrent.Future, Class) Futures.get}
   * or {@link google.common.util.concurrent.Futures#makeChecked}.
   */
  ...
  /**
   * Invokes
   * {@code future.}{@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit) get(timeout, unit)}
   * uninterruptibly.
   *
   * <p>If instead, you wish to treat {@link InterruptedException} uniformly
   * with other exceptions, see {@link google.common.util.concurrent.Futures#get(java.util.concurrent.Future, Class) Futures.get}
  ...
  /**
   * Invokes
   * {@code unit.}{@link java.util.concurrent.TimeUnit#timedJoin(Thread, long)
  ...
  /**
   * Invokes {@code queue.}{@link java.util.concurrent.BlockingQueue#take() take()} uninterruptibly.
   */
  ...
  /**
   * Invokes {@code queue.}{@link java.util.concurrent.BlockingQueue#put(Object) put(element)}
   * uninterruptibly.
   */
