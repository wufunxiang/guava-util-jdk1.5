 ...
 *
 * <p>This class uses the {@link java.util.concurrent.ScheduledExecutorService} returned from {@link #executor} to run
 ...
 * {@link google.common.util.concurrent.AbstractScheduledService.Scheduler}. When this service is asked to stop via {@link #stop} or {@link #stopAndWait},
...
public abstract class AbstractScheduledService implements Service {
  ...
  /**
   * A scheduler defines the policy for how the {@link google.common.util.concurrent.AbstractScheduledService} should run its
   * task.
   *
   * <p>Consider using the {@link #newFixedDelaySchedule} and {@link #newFixedRateSchedule} factory
   * methods, these provide {@link google.common.util.concurrent.AbstractScheduledService.Scheduler} instances for the common use case of running the
   * service with a fixed schedule.  If more flexibility is needed then consider subclassing the
   * {@link google.common.util.concurrent.AbstractScheduledService.CustomScheduler} abstract class in preference to creating your own {@link google.common.util.concurrent.AbstractScheduledService.Scheduler}
   * implementation.
   *
   * @author Luke Sandberg
   * @since 11.0
  ...
  public abstract static class Scheduler {
    /**
     * Returns a {@link google.common.util.concurrent.AbstractScheduledService.Scheduler} that schedules the task using the
     * {@link java.util.concurrent.ScheduledExecutorService#scheduleWithFixedDelay} method.
     *
    ...
    /**
     * Returns a {@link google.common.util.concurrent.AbstractScheduledService.Scheduler} that schedules the task using the
     * {@link java.util.concurrent.ScheduledExecutorService#scheduleAtFixedRate} method.
     *
     * @param initialDelay the time to delay first execution
  ...
  /**
   * Returns the {@link google.common.util.concurrent.AbstractScheduledService.Scheduler} object used to configure this service.  This method will only be
   * called once.
   */
  protected abstract Scheduler scheduler();

  /**
   * Returns the {@link java.util.concurrent.ScheduledExecutorService} that will be used to execute the {@link #startUp},
   * {@link #runOneIteration} and {@link #shutDown} methods.  The executor will not be
   * {@link java.util.concurrent.ScheduledExecutorService#shutdown} when this service stops. Subclasses may override this
   * method to use a custom {@link java.util.concurrent.ScheduledExecutorService} instance.
   *
   * <p>By default this returns a new {@link java.util.concurrent.ScheduledExecutorService} with a single thread thread
  ...
  /**
   * A {@link google.common.util.concurrent.AbstractScheduledService.Scheduler} that provides a convenient way for the {@link google.common.util.concurrent.AbstractScheduledService} to
  ...
  public abstract static class CustomScheduler extends Scheduler {
    ...
    /**
     * A callable class that can reschedule itself using a {@link google.common.util.concurrent.AbstractScheduledService.CustomScheduler}.
     */
     ...
     * google.common.util.concurrent.AbstractScheduledService#runOneIteration}.
     *
