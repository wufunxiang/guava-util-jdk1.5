 ...
 * threads
 * <li> a {@linkplain google.common.util.concurrent.ThreadFactoryBuilder#setNameFormat naming format}
...
public final class ThreadFactoryBuilder {
  ...
  /**
   * Sets the {@link java.lang.Thread.UncaughtExceptionHandler} for new threads created with this
   * ThreadFactory.
   *
  ...
  /**
   * Sets the backing {@link java.util.concurrent.ThreadFactory} for new threads created with this
   * ThreadFactory. Threads will be created by invoking #newThread(Runnable) on
   * this backing {@link java.util.concurrent.ThreadFactory}.
   *
   * @param backingThreadFactory the backing {@link java.util.concurrent.ThreadFactory} which will
   *     be delegated to during thread creation.
   * @return this for the builder pattern
   *
   * @see google.common.util.concurrent.MoreExecutors
   */
