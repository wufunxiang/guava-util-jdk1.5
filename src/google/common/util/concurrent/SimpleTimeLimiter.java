...
import google.common.collect.ObjectArrays;
 ...
 * {@link java.util.concurrent.ExecutorService}.  If the time limit expires for a given method call,
...
public final class SimpleTimeLimiter implements TimeLimiter {
   ...
   * java.util.concurrent.Executors#newCachedThreadPool()} to execute proxied method calls.
   *
