...
import google.common.collect.Queues;
 ...
 * java.util.concurrent.ExecutorService}, and {@link java.util.concurrent.ThreadFactory}.
 *
...
public final class MoreExecutors {
   ...
   * {@link java.util.concurrent.ExecutorService service}.  This is useful if the given service uses
   ...
   * that invokes {@code execute/submit}, as in {@link java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy}  This
  ...
  private static class SameThreadExecutorService
     ...
     * task count.
     *
     * @throws java.util.concurrent.RejectedExecutionException if the executor has been previously
     *         shutdown
     */
  ...
  /**
   * Creates an {@link java.util.concurrent.ExecutorService} whose {@code submit} and {@code
   * invokeAll} methods submit {@link google.common.util.concurrent.ListenableFutureTask} instances to the
  ...
  /**
   * Creates a {@link java.util.concurrent.ScheduledExecutorService} whose {@code submit} and {@code
   * invokeAll} methods submit {@link google.common.util.concurrent.ListenableFutureTask} instances to the
   * given delegate executor. Those methods, as well as {@code execute} and
   * {@code invokeAny}, are implemented in terms of calls to {@code
   * delegate.execute}. All other methods are forwarded unchanged to the
  ...
  /**
   * An implementation of {@link java.util.concurrent.ExecutorService#invokeAny} for {@link google.common.util.concurrent.ListeningExecutorService}
   * implementations.
