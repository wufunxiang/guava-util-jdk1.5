...
import google.common.collect.ImmutableSet;
...
/**
 * The {@code CycleDetectingLockFactory} creates {@link java.util.concurrent.locks.ReentrantLock}s and
 * {@link java.util.concurrent.locks.ReentrantReadWriteLock}s that detect potential deadlock by checking
 ...
 * execution of the {@link google.common.util.concurrent.CycleDetectingLockFactory.Policy} specified when creating the factory. The
 ...
 * <p>
 * The {@link google.common.util.concurrent.CycleDetectingLockFactory.WithExplicitOrdering} class can be used
...
public class CycleDetectingLockFactory {
   ...
   * encountered. Clients can use one of the predefined {@link google.common.util.concurrent.CycleDetectingLockFactory.Policies} or
  ...
  /**
   * Pre-defined {@link google.common.util.concurrent.CycleDetectingLockFactory.Policy} implementations.
   *
   * @since 13.0
   */
  @Beta
  public enum Policies implements Policy {
     ...
     * of a {@link java.util.logging.Level#SEVERE} message indicating the potential deadlock,
  ...
  /**
   * Creates a {@link java.util.concurrent.locks.ReentrantLock} with the given fairness policy. The
  ...
  /**
   * Creates a {@link java.util.concurrent.locks.ReentrantReadWriteLock} with the given fairness policy.
  ...
  public static final class WithExplicitOrdering<E extends Enum<E>>
    ...
    /**
     * Creates a {@link java.util.concurrent.locks.ReentrantLock} with the given fairness policy and rank.
   ...
   * calls to {@link #aboutToAcquire(google.common.util.concurrent.CycleDetectingLockFactory.CycleDetectingLock)} and
   * {@link #lockStateChanged(google.common.util.concurrent.CycleDetectingLockFactory.CycleDetectingLock)}.
   */
  ...
  private interface CycleDetectingLock {
    ...
    /** @return the {@link google.common.util.concurrent.CycleDetectingLockFactory.LockGraphNode} associated with this lock. */
  ...
  private static class LockGraphNode {
     ...
     *
     * @return If a path was found, a chained {@link google.common.util.concurrent.CycleDetectingLockFactory.ExampleStackTrace}
