 ...
 * the {@link #checkedGet()} and {@link #checkedGet(long, java.util.concurrent.TimeUnit)} methods.
 *
 * @author Sven Mawson
 * @since 1.0
 */
...
public abstract class AbstractCheckedFuture<V, X extends Exception>
   ...
   * {@link java.util.concurrent.CancellationException} or {@link java.util.concurrent.ExecutionException} thrown by
   ...
   *         {@link java.util.concurrent.CancellationException}, or {@link java.util.concurrent.ExecutionException}
   */
   ...
   * {@inheritDoc}
   *
   * <p>This implementation calls {@link #get(long, java.util.concurrent.TimeUnit)} and maps that
   * method's standard exceptions (excluding {@link java.util.concurrent.TimeoutException}, which is
   ...
   * @throws X if {@link #get()} throws an {@link InterruptedException},
   *         {@link java.util.concurrent.CancellationException}, or {@link java.util.concurrent.ExecutionException}
   * @throws java.util.concurrent.TimeoutException {@inheritDoc}
   */
