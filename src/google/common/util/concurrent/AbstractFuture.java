 ...
 *
 * <p>{@code AbstractFuture} uses an {@link java.util.concurrent.locks.AbstractQueuedSynchronizer} to deal
...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
   ...
   * {@inheritDoc}
   *
   * <p>The default {@link google.common.util.concurrent.AbstractFuture} implementation throws {@code
   ...
   * {@link google.common.util.concurrent.AbstractFuture.Sync#COMPLETED} and invoke the listeners if the
  ...
  static final class Sync<V> extends AbstractQueuedSynchronizer {
     ...
     * {@link java.util.concurrent.TimeoutException} if the timer expires, otherwise behaves like
     * {@link #get()}.
     */
     ...
     * successfully called.  Throws a {@link java.util.concurrent.CancellationException} if the task
     * was cancelled, or a {@link java.util.concurrent.ExecutionException} if the task completed with
     * an error.
     */
