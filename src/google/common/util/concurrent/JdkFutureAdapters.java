 ...
 * java.util.concurrent.Future} instances. Note that, whenver possible, it is strongly preferred to
...
public final class JdkFutureAdapters {
  /**
   * Assigns a thread to the given {@link java.util.concurrent.Future} to provide {@link
   ...
   * until the future is {@linkplain java.util.concurrent.Future#isDone() done}.
   *
   ...
   * {@link google.common.util.concurrent.AbstractFuture}, and other utilities over creating plain {@code
  ...
  /**
   * Submits a blocking task for the given {@link java.util.concurrent.Future} to provide {@link
   * ListenableFuture} functionality.
   *
   * <p><b>Warning:</b> If the input future does not already implement {@code
   * ListenableFuture}, the returned future will emulate {@link
   ...
   * is {@linkplain java.util.concurrent.Future#isDone() done}, so each call to this method may
  ...
  /**
   * An adapter to turn a {@link java.util.concurrent.Future} into a {@link ListenableFuture}.  This
