 ...
 * information, see {@link Futures#transform(ListenableFuture, google.common.util.concurrent.AsyncFunction)}.
 *
 * @author Chris Povirk
 * @since 11.0
 */
...
public interface AsyncFunction<I, O> {
   ...
   * input}. The output {@code Future} need not be {@linkplain java.util.concurrent.Future#isDone
