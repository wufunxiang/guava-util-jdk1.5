...
import static google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static google.common.util.concurrent.Uninterruptibles.putUninterruptibly;
import static google.common.util.concurrent.Uninterruptibles.takeUninterruptibly;
...
import google.common.collect.Lists;
import google.common.collect.Ordering;
...
public final class Futures {
  ...
  /**
   * Creates a {@link google.common.util.concurrent.CheckedFuture} out of a normal {@link ListenableFuture}
   * and a {@link google.common.base.Function} that maps from {@link Exception} instances into the
   * appropriate checked type.
   *
   * <p>The given mapping function will be applied to an
   * {@link InterruptedException}, a {@link java.util.concurrent.CancellationException}, or an
   * {@link java.util.concurrent.ExecutionException} with the actual cause of the exception.
   * See {@link java.util.concurrent.Future#get()} for details on the exceptions thrown.
   *
   ...
   * google.common.util.concurrent.AsyncFunction, java.util.concurrent.Executor) supplying an executor}. If you do not supply an
   ...
   * consider {@linkplain #transform(ListenableFuture, google.common.util.concurrent.AsyncFunction) omitting
   ...
   * #transform(ListenableFuture, google.common.base.Function, java.util.concurrent.Executor) supplying an executor}.
   ...
   * #transform(ListenableFuture, google.common.base.Function) omitting the executor} or
  ...
  /**
   * Like {@link #transform(ListenableFuture, google.common.base.Function)} except that the
   * transformation {@code function} is invoked on each call to
   * {@link java.util.concurrent.Future#get() get()} on the returned future.
   *
   ...
   *
   * <p>Note that calls to {@linkplain java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit) timed get}
   ...
   * #transform(ListenableFuture, google.common.util.concurrent.AsyncFunction)}, in that the returned {@code
   ...
   * #addCallback(ListenableFuture, google.common.util.concurrent.FutureCallback, java.util.concurrent.Executor) supplying an
   ...
   * #addCallback(ListenableFuture, google.common.util.concurrent.FutureCallback) omitting the executor} or
   * explicitly specifying {@code sameThreadExecutor}. However, be aware of the
   * caveats documented in the link above.
   *
   * <p>For a more general interface to attach a completion listener to a
  ...
  /**
   * Returns the result of {@link java.util.concurrent.Future#get()}, converting most exceptions to a
   ...
   * <ul>
   * <li>Any {@link java.util.concurrent.ExecutionException} has its <i>cause</i> wrapped in an
   *     {@code X} if the cause is a checked exception, an {@link
   *     UncheckedExecutionException} if the cause is a {@code
   *     RuntimeException}, or an {@link google.common.util.concurrent.ExecutionError} if the cause is an
   *     {@code Error}.
   ...
   * @throws google.common.util.concurrent.ExecutionError if {@code get} throws an {@code ExecutionException}
  ...
  /**
   * Returns the result of {@link java.util.concurrent.Future#get(long, java.util.concurrent.TimeUnit)}, converting most
   ...
   * <li>Any {@link InterruptedException} is wrapped in an {@code X} (after
   *     restoring the interrupt).
   * <li>Any {@link java.util.concurrent.TimeoutException} is wrapped in an {@code X}.
   * <li>Any {@link java.util.concurrent.CancellationException} is propagated untouched, as is any
   *     other {@link RuntimeException} (though {@code get} implementations are
   *     discouraged from throwing such exceptions).
   * </ul>
  ...
  /**
   * Returns the result of calling {@link java.util.concurrent.Future#get()} uninterruptibly on a
   ...
   *     Exception}) or {@link google.common.util.concurrent.ExecutionError} (if the cause is an {@code
   *     Error}).
   ...
   * <li>Any {@link java.util.concurrent.CancellationException} is propagated untouched. So is any
   ...
   * {@link Uninterruptibles#getUninterruptibly(java.util.concurrent.Future)}.
   *
   * @throws UncheckedExecutionException if {@code get} throws an {@code
