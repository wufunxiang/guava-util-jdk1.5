...
import google.common.collect.ForwardingObject;
 ...
 *
 * <p>Most subclasses can just use {@link google.common.util.concurrent.ForwardingFuture.SimpleForwardingFuture}.
 * 
 * @author Sven Mawson
 * @since 1.0
 */
public abstract class ForwardingFuture<V> extends ForwardingObject
   ...
   */
  /**
   * A simplified version of {@link google.common.util.concurrent.ForwardingFuture} where subclasses
   * can pass in an already constructed {@link java.util.concurrent.Future} as the delegate.
   * 
   * @since 9.0
   */
