...
/**
 * A {@link java.util.concurrent.FutureTask} that also implements the {@link google.common.util.concurrent.ListenableFuture}
 * interface.  Unlike {@code FutureTask}, {@code ListenableFutureTask} does not
 * provide an overrideable {@link java.util.concurrent.FutureTask#done() done()} method.  For similar
