 ...
 * java.util.Map} whose keys are the columns. The reverse is also available, associating a
...
public interface Table<R, C, V> {
  ...
  interface Cell<R, C, V> {
     ...
     * google.common.base.Objects#hashCode}{@code (e.getRowKey(), e.getColumnKey(), e.getValue())}.
     */
    @Override
    int hashCode();
  }
