 ...
 * or an explicit {@link java.util.Comparator}. In all cases, this implementation uses
 * {@link Comparable#compareTo} or {@link java.util.Comparator#compare} instead of {@link Object#equals} to
...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
   ...
   *
   * <p>This implementation is highly efficient when {@code elements} is itself a {@link google.common.collect.Multiset}.
   *
   * <p>The type specification is {@code <E extends Comparable>}, instead of the more specific
   * {@code <E extends Comparable<? super E>>}, to support classes defined without generics.
   */
