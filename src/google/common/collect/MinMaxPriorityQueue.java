 ...
 *
 * <p>As a {@link java.util.Queue} it functions exactly as a {@link java.util.PriorityQueue}: its
 ...
 * structure used in {@link java.util.PriorityQueue}.
 *
 ...
 *     this class is functionally equivalent to {@link java.util.PriorityQueue}, but
...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
   ...
   * google.common.collect.MinMaxPriorityQueue#orderedBy(java.util.Comparator)}, {@link
   * google.common.collect.MinMaxPriorityQueue#expectedSize(int)} or {@link
   * google.common.collect.MinMaxPriorityQueue#maximumSize(int)}.
   *
   ...
   * circumstances it returns a pair of elements as a {@link google.common.collect.MinMaxPriorityQueue.MoveDesc}. The
   ...
   * general contract of {@link java.util.PriorityQueue#comparator}, but returns {@link
