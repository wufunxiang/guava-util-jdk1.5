...
import google.common.base.Joiner.MapJoiner;
...
import google.common.collect.MapDifference.ValueDifference;
...
/**
 * Static utility methods pertaining to {@link java.util.Map} instances (including instances of
 * {@link java.util.SortedMap}, {@link google.common.collect.BiMap}, etc.). Also see this class's counterparts
 * {@link google.common.collect.Lists}, {@link Sets} and {@link Queues}.
 *
...
public final class Maps {
   ...
   * google.common.collect.ImmutableMap#of()} instead.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * google.common.collect.ImmutableMap#copyOf(java.util.Map)} instead.
   *
   ...
   *
   * <p>This is currently accomplished by calling {@link google.common.collect.MapMaker#makeMap()}.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * google.common.collect.ImmutableSortedMap#of()} instead.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required, use {@link
   * google.common.collect.ImmutableSortedMap#copyOfSorted(java.util.SortedMap)} instead.
   *
  ...
  /**
   * Returns an immutable map for which the {@link java.util.Map#values} are the given
  ...
  /** @see google.common.collect.Maps#unmodifiableEntrySet(java.util.Set) */
  ...
  /** @see google.common.collect.Maps#unmodifiableBiMap(google.common.collect.BiMap) */
   ...
   * applied many times for bulk operations like {@link java.util.Map#containsValue} and
   ...
   * java.util.Map#containsValue} and {@link Object#toString}. For this to perform well,
   ...
   * {@link google.common.collect.Maps#transformEntries(java.util.Map, google.common.collect.Maps.EntryTransformer)}.
   *
  ...
  public interface EntryTransformer<K, V1, V2> {
     ...
     *     {@link google.common.base.Objects#equal Objects.equal}{@code (k1, k2) &&}
     *     {@link google.common.base.Objects#equal}{@code (v1, v2)} implies that {@code
   ...
   * equals</i>, as documented at {@link google.common.base.Predicate#apply}. Do not provide a
   ...
   * putAll()}, and {@link java.util.Map.Entry#setValue} methods throw an {@link
   ...
   * Similarly, the map's entries have a {@link java.util.Map.Entry#setValue} method that
   ...
   * equals</i>, as documented at {@link google.common.base.Predicate#apply}.
   */
  ...
  /**
   * Delegates to {@link java.util.Map#get}. Returns {@code null} on {@code
   * ClassCastException}.
   */
  ...
  /**
   * Delegates to {@link java.util.Map#containsKey}. Returns {@code false} on {@code
   * ClassCastException}
   */
  ...
  /**
   * An implementation of {@link java.util.Map#equals}.
   */
  ...
  /**
   * An implementation of {@link java.util.Map#hashCode}.
   */
  ...
  /**
   * An implementation of {@link java.util.Map#toString}.
   */
  ...
  /**
   * An implementation of {@link java.util.Map#putAll}.
   */
  ...
  /**
   * An admittedly inefficient implementation of {@link java.util.Map#containsKey}.
   */
  ...
  /**
   * An implementation of {@link java.util.Map#containsValue}.
   */
