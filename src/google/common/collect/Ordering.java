 ...
 * google.common.collect.FluentIterable} is an enriched {@link Iterable}). For example: <pre>   {@code
 *
 *   if (Ordering.from(comparator).reverse().isOrdered(list)) { ... }}</pre>
 *
 * The {@link #from(java.util.Comparator)} method returns the equivalent {@code Ordering}
...
public abstract class Ordering<T> implements Comparator<T> {
   ...
   * equals</i> (as defined {@linkplain java.util.Comparator here}). Avoid its use in
   * APIs, such as {@link java.util.TreeSet#TreeSet(java.util.Comparator)}, where such consistency
   * is expected.
   *
   ...
   * {@link Object#equals(Object)}" as defined by {@link java.util.Comparator}. Use
   * caution when building a {@link java.util.SortedSet} or {@link java.util.SortedMap} from it, as
   ...
   * {@link java.util.Collections#reverseOrder(java.util.Comparator)}.
   */
   ...
   * is equivalent to one created using {@link google.common.collect.Ordering#compound(Iterable)} on
   ...
   * such as a {@link java.util.HashSet}, will produce non-deterministic results.
   *
   ...
   * @throws java.util.NoSuchElementException if {@code iterator} is empty
  ...
  /**
   * {@link java.util.Collections#binarySearch(java.util.List, Object, java.util.Comparator) Searches}
  ...
  /**
   * Exception thrown by a {@link google.common.collect.Ordering#explicit(java.util.List)} or {@link
   * google.common.collect.Ordering#explicit(Object, Object[])} comparator when comparing a value
