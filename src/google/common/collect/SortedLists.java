...
/**
 * Static methods pertaining to sorted {@link java.util.List} instances.
 *
...
@Beta final class SortedLists {
  ...
  public enum KeyAbsentBehavior {
     ...
     * {@link java.util.Collections#binarySearch(java.util.List, Object)} when the key isn't present, since
   ...
   * algorithm.
   *
   * <p>Equivalent to {@link #binarySearch(java.util.List, google.common.base.Function, Object, java.util.Comparator, google.common.collect.SortedLists.KeyPresentBehavior,
   * google.common.collect.SortedLists.KeyAbsentBehavior)} using {@link google.common.collect.Ordering#natural}.
   */
   ...
   *
   * <p>Equivalent to
   * {@link #binarySearch(java.util.List, Object, java.util.Comparator, google.common.collect.SortedLists.KeyPresentBehavior, google.common.collect.SortedLists.KeyAbsentBehavior)} using
   * {@link google.common.collect.Lists#transform(java.util.List, google.common.base.Function) Lists.transform(list, keyFunction)}.
   */
   ...
   * {@link java.util.Collections#sort(java.util.List, java.util.Comparator) Collections.sort(List, Comparator)} method), prior
   ...
   * {@link google.common.collect.SortedLists.KeyPresentBehavior} decides which index is returned. If no elements compare as equal to
   * the key, the choice of {@link google.common.collect.SortedLists.KeyAbsentBehavior} decides which index is returned.
   *
