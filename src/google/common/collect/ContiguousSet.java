 ...
 * operations on such a set can be performed efficiently, but others (such as {@link java.util.Set#hashCode}
 * or {@link java.util.Collections#frequency}) can cause major performance problems.
 *
 * @author Gregory Kick
 * @since 10.0
 */
...
public abstract class ContiguousSet<C extends Comparable> extends ImmutableSortedSet<C> {
   ...
   * {@link Sets#intersection} for {@link google.common.collect.ContiguousSet} instances.
   */
   ...
   *
   * <p>Note that this method will return ranges with unbounded endpoints if {@link google.common.collect.BoundType#OPEN}
