...
import static google.common.collect.Iterables.getOnlyElement;
...
/**
 * An immutable, hash-based {@link java.util.Map} with reliable user-specified iteration
 * order. Does not permit null keys or values.
 *
 * <p>Unlike {@link java.util.Collections#unmodifiableMap}, which is a <i>view</i> of a
 ...
 * caller.
 *
 * <p><i>Performance notes:</i> unlike {@link java.util.HashMap}, {@code ImmutableMap} is
...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
   ...
   * {@link java.util.Collections#emptyMap}, and is preferable mainly for consistency
   ...
   * performs comparably to {@link java.util.Collections#singletonMap} but will not accept
   ...
   * created by the {@link google.common.collect.ImmutableMap.Builder} constructor.
   */
   ...
   *
   * <p>A call to {@link java.util.Map.Entry#setValue} on the returned entry will always
  ...
  public static class Builder<K, V> {
     ...
     * generated by {@link google.common.collect.ImmutableMap#builder}.
     */
    public Builder() {}
