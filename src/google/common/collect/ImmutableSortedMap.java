...
/**
 * An immutable {@link java.util.SortedMap}. Does not permit null keys or values.
 *
 * <p>Unlike {@link java.util.Collections#unmodifiableSortedMap}, which is a <i>view</i>
...
public abstract class ImmutableSortedMap<K, V>
   ...
   * Comparator<Number>}, use the {@link google.common.collect.ImmutableSortedMap.Builder} constructor instead.
   *
  ...
  public static class Builder<K, V> extends ImmutableMap.Builder<K, V> {
     ...
     * generated by {@link google.common.collect.ImmutableSortedMap#orderedBy}.
     */
   ...
   * Note that its behavior is not consistent with {@link java.util.TreeMap#comparator()},
   ...
   *
   * <p>The {@link java.util.SortedMap#headMap} documentation states that a submap of a
   ...
   * exclusive.
   *
   * <p>The {@link java.util.SortedMap#subMap} documentation states that a submap of a
   ...
   *
   * <p>The {@link java.util.SortedMap#tailMap} documentation states that a submap of a
   * submap throws an {@link IllegalArgumentException} if passed a {@code
   * fromKey} less than an earlier {@code fromKey}. However, this method doesn't
   * throw an exception in that situation, but instead keeps the original {@code
   * fromKey}.
