...
/**
 * Factories and utilities pertaining to the {@link google.common.collect.Constraint} interface.
 *
 * @see MapConstraints
 * @author Mike Bostock
 * @author Jared Levy
...
public final class Constraints {
  ...
  /** @see google.common.collect.Constraints#constrainedCollection */
  ...
  /** @see google.common.collect.Constraints#constrainedSet */
  ...
  /** @see google.common.collect.Constraints#constrainedSortedSet */
   ...
   * elements satisfy the constraint.
   *
   * <p>If {@code list} implements {@link java.util.RandomAccess}, so will the returned
  ...
  /** @see google.common.collect.Constraints#constrainedList */
  @GwtCompatible
  ...
  /** @see google.common.collect.Constraints#constrainedListIterator */
  ...
  /** @see google.common.collect.Constraints#constrainedMultiset */
