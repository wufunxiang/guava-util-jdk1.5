 ...
 * of type {@link java.util.Iterator}. Except as noted, each method has a corresponding
 * {@link Iterable}-based method in the {@link google.common.collect.Iterables} class.
 *
...
public final class Iterators {
   ...
   * #find(java.util.Iterator, google.common.base.Predicate, Object)} instead.
   *
   * @throws java.util.NoSuchElementException if no element in {@code iterator} matches
   *     the given predicate
   */
   ...
   * no such element is found, an empty {@link google.common.base.Optional} will be returned from
   ...
   * the iterator is empty.  The {@link google.common.collect.Iterables} analog to this method is
   * {@link google.common.collect.Iterables#getFirst}.
   *
   * @param defaultValue the default value to return if the iterator is empty
   ...
   *
   * <p>The provided iterator must support {@link java.util.Iterator#remove()} or
   ...
   * collection type, for example using {@link java.util.Arrays#asList(Object[])}, making
   * this method unnecessary.
   *
   * <p>The {@code Iterable} equivalent of this method is either {@link
   * java.util.Arrays#asList(Object[])}, {@link google.common.collect.ImmutableList#copyOf(Object[])}},
   * or {@link google.common.collect.ImmutableList#of}.
   */
   ...
   *
   * <p>This method has no equivalent in {@link google.common.collect.Iterables} because viewing an
   ...
   *
   * <p>The {@code Iterable} equivalent of this method is either {@link
   * java.util.Collections#enumeration} (if you have a {@link java.util.Collection}), or
