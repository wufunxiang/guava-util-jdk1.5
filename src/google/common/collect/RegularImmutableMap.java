...
/**
 * Implementation of {@link google.common.collect.ImmutableMap} with two or more entries.
 *
 * @author Jesse Wilson
...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
  ...
  /**
   * Creates a {@link google.common.collect.RegularImmutableMap.LinkedEntry} array to hold parameterized entries. The
