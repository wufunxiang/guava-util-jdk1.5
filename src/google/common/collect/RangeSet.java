...
/**
 * A set of values of type {@code C} made up of zero or more <i>disjoint</i> {@linkplain google.common.collect.Range
 * ranges}.
 *
 * <p>It is guaranteed that {@linkplain google.common.collect.Range#isConnected connected} ranges will be
 * {@linkplain google.common.collect.Range#span coalesced} together, and that {@linkplain google.common.collect.Range#isEmpty empty} ranges
 * will never be held in a {@code RangeSet}.
 *
 * <p>For a {@link java.util.Set} whose contents are specified by a {@link google.common.collect.Range}, see {@link google.common.collect.ContiguousSet}.
 *
 ...
 */ abstract class RangeSet<C extends Comparable> {
  ...
  /**
   * Returns the unique range from this range set that {@linkplain google.common.collect.Range#contains contains}
  ...
  /**
   * Returns a view of the {@linkplain google.common.collect.Range#isConnected disconnected} ranges that make up this
   ...
   *
   * <p>Note that {@code range} will be {@linkplain google.common.collect.Range#span(google.common.collect.Range) coalesced} with any ranges in
   * the range set that are {@linkplain google.common.collect.Range#isConnected(google.common.collect.Range) connected} with it.  Moreover,
   ...
   * {@linkplain google.common.collect.Range#encloses encloses} the specified range.
   */
   ...
   * this range set which {@linkplain google.common.collect.Range#encloses encloses} it. It follows that
   ...
   * {@linkplain #enclosesAll(google.common.collect.RangeSet) encloses} both the original range set and {@code other}.
   *
   * <p>
   ...
   * according to {@link google.common.collect.Range#equals(Object)}.
   */
  @Override
