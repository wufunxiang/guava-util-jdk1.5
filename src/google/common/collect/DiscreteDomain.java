...
public abstract class DiscreteDomain<C extends Comparable> {
   ...
   * @throws java.util.NoSuchElementException if the type has no (practical) minimum
   ...
   * @throws java.util.NoSuchElementException if the type has no (practical) maximum
   *     value; for example, {@link java.math.BigInteger}
   */
  public C maxValue() {
    throw new NoSuchElementException();
