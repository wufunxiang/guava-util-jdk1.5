 ...
 * google.common.collect.Multimap} documentation for information common to all multimaps.
 *
 * <p>The {@link #get}, {@link #removeAll}, and {@link #replaceValues} methods
 * each return a {@link java.util.Set} of values, while {@link #entries} returns a {@code
...
public interface SetMultimap<K, V> extends Multimap<K, V> {
   ...
   * method returns a {@link java.util.Set}, instead of the {@link java.util.Collection}
   * specified in the {@link google.common.collect.Multimap} interface.
   */
