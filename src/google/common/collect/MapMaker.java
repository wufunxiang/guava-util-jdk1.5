...
import static google.common.base.Objects.firstNonNull;
...
import google.common.base.Ascii;
import google.common.base.Equivalence;
import google.common.base.Function;
import google.common.base.Objects;
import google.common.base.Ticker;
import google.common.collect.ComputingConcurrentHashMap.ComputingMapAdapter;
import google.common.collect.MapMakerInternalMap.Strength;
...
/**
 * <p>A builder of {@link java.util.concurrent.ConcurrentMap} instances having any combination of the following features:
 *
 * <ul>
 * <li>keys or values automatically wrapped in {@linkplain java.lang.ref.WeakReference weak} or {@linkplain
 *     java.lang.ref.SoftReference soft} references
 ...
 * that behaves similarly to a {@link java.util.concurrent.ConcurrentHashMap}.
 *
 * <p>The returned map is implemented as a hash table with similar performance characteristics to
 * {@link java.util.concurrent.ConcurrentHashMap}. It supports all optional operations of the {@code ConcurrentMap}
 ...
 * iterators never throw {@link java.util.ConcurrentModificationException}.
 *
 ...
 * java.util.Map.Entry} instance retrieved from the map's {@linkplain java.util.Map#entrySet entry set} is a
...
public final class MapMaker extends GenericMapMaker<Object, Object> {
   ...
   *
   * <p>By default, the map uses {@link google.common.base.Equivalence#identity} to determine key equality when
   * {@link #weakKeys} or {@link #softKeys} is specified, and {@link google.common.base.Equivalence#equals()}
   * otherwise. The only place this is used is in {@link google.common.collect.Interners.WeakInterner}.
   */
   ...
   * {@link google.common.cache.CacheBuilder}.
   *
   * @param size the maximum size of the map
   * @throws IllegalArgumentException if {@code size} is negative
   * @throws IllegalStateException if a maximum size was already set
   * @deprecated Caching functionality in {@code MapMaker} is being moved to
   *     {@link google.common.cache.CacheBuilder}, with {@link #maximumSize} being
   *     replaced by {@link google.common.cache.CacheBuilder#maximumSize}. Note that {@code
   ...
   * comparison to determine equality of keys, which is a technical violation of the {@link java.util.Map}
   ...
   * {@link java.lang.ref.SoftReference} (by default, strong references are used). Softly-referenced objects will
   ...
   * {@link java.lang.ref.WeakReference} (by default, strong references are used).
   *
   ...
   * the methods {@link java.util.Map#containsValue containsValue},
   * {@link java.util.concurrent.ConcurrentMap#remove(Object, Object) remove(Object, Object)} and
   * {@link java.util.concurrent.ConcurrentMap#replace(Object, Object, Object) replace(K, V, V)}, and may not be what you
   * expect.
   *
   ...
   * a code change.
   *
   * <p>Expired entries may be counted by {@link java.util.Map#size}, but will never be visible to read or
   ...
   * @deprecated Caching functionality in {@code MapMaker} is being moved to
   *     {@link google.common.cache.CacheBuilder}, with {@link #expireAfterWrite} being
   *     replaced by {@link google.common.cache.CacheBuilder#expireAfterWrite}. Note that {@code
   *     CacheBuilder} is simply an enhanced API for an implementation which was branched from
   *     {@code MapMaker}.
   */
  @Deprecated
   ...
   * @deprecated Caching functionality in {@code MapMaker} is being moved to
   *     {@link google.common.cache.CacheBuilder}, with {@link #expireAfterAccess} being
   *     replaced by {@link google.common.cache.CacheBuilder#expireAfterAccess}. Note that
   ...
   * after removing an element for any reason (see removal causes in {@link google.common.collect.MapMaker.RemovalCause}). It will
   ...
   * MapMaker} and building your {@link java.util.Map} all in a single statement.
   *
   ...
   * @deprecated Caching functionality in {@code MapMaker} is being moved to
   *     {@link google.common.cache.CacheBuilder}, with {@link #removalListener} being
   *     replaced by {@link google.common.cache.CacheBuilder#removalListener}. Note that {@code
   *     CacheBuilder} is simply an enhanced API for an implementation which was branched from
   *     {@code MapMaker}.
   */
  @Deprecated
  ...
  /**
   * Builds a map that supports atomic, on-demand computation of values. {@link java.util.Map#get} either
   ...
   *
   * <p>New code should use {@link google.common.cache.CacheBuilder}, which supports
   * {@linkplain google.common.cache.CacheStats statistics} collection, introduces the
   * {@link google.common.cache.CacheLoader} interface for loading entries into the cache
   ...
   *
   * <p>{@link java.util.Map#get} on the returned map will never return {@code null}. It may throw:
   *
   * <ul>
   * <li>{@link NullPointerException} if the key is null or the computing function returns a null
   *     result
   * <li>{@link google.common.collect.ComputationException} if an exception was thrown by the computing function. If that
   * exception is already of type {@link google.common.collect.ComputationException} it is propagated directly; otherwise
   * it is wrapped.
   * </ul>
   *
   ...
   *
   * <p>If {@link java.util.Map#put} is called before a computation completes, other threads waiting on the
   ...
   * the iterator. They do not throw {@link java.util.ConcurrentModificationException}, and may proceed
   ...
   * @return a serializable concurrent map having the requested features
   * @deprecated Caching functionality in {@code MapMaker} is being moved to
   *     {@link google.common.cache.CacheBuilder}, with {@link #makeComputingMap} being replaced
   *     by {@link google.common.cache.CacheBuilder#build}. See the
  ...
  static final class RemovalNotification<K, V> extends ImmutableEntry<K, V> {
     ...
     * {@link google.common.collect.MapMaker.RemovalCause#EXPLICIT} nor {@link google.common.collect.MapMaker.RemovalCause#REPLACED}).
     */
  ...
  enum RemovalCause {
     ...
     * result from the user invoking {@link java.util.Map#put}, {@link java.util.Map#putAll},
     * {@link java.util.concurrent.ConcurrentMap#replace(Object, Object)}, or
