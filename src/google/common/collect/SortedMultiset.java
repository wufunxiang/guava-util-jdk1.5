...
/**
 * A {@link google.common.collect.Multiset} which maintains the ordering of its elements, according to
 * either their natural order or an explicit {@link java.util.Comparator}. In all cases,
 * this implementation uses {@link Comparable#compareTo} or
 * {@link java.util.Comparator#compare} instead of {@link Object#equals} to determine
 ...
 * resulting multiset will violate the {@link java.util.Collection} contract, which it is
...
public interface SortedMultiset<E> extends Multiset<E>, SortedIterable<E> {
   ...
   * {@link google.common.collect.Ordering#natural()} if the natural ordering of the elements is used.
   */
  ...
  /**
   * Returns a {@link java.util.SortedSet} view of the distinct elements in this multiset.
   */
