...
final class Serialization {
   ...
   * #writeMap(java.util.Map, java.io.ObjectOutputStream)}, the number of distinct elements in a
   * multiset serialized by {@link
   * #writeMultiset(google.common.collect.Multiset, java.io.ObjectOutputStream)}, or the number of distinct
   * keys in a multimap serialized by {@link
   * #writeMultimap(google.common.collect.Multimap, java.io.ObjectOutputStream)}.
   *
   ...
   * change while the method is running. The {@link google.common.collect.Multimap#asMap} view
