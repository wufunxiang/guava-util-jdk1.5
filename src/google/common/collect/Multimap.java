...
/**
 * A collection that maps keys to values, similar to {@link java.util.Map}, but in which
 ...
 *     are similar to the corresponding view collections of {@link java.util.Map}
 ...
 * subinterfaces {@link google.common.collect.ListMultimap} and {@link SetMultimap}. These take their
 * names from the fact that the collections they return from {@code get} behave
 * like (and, of course, implement) {@link java.util.List} and {@link java.util.Set}, respectively.
 *
 ...
 * google.common.collect.ImmutableListMultimap} and {@link google.common.collect.ImmutableSetMultimap}. General-purpose
 ...
 * Map} and {@link java.util.Collection} types, using the {@link Multimaps#newMultimap
...
public interface Multimap<K, V> {
   ...
   * but equality of two {@link google.common.collect.ListMultimap} instances depends on the ordering
   * of the values for each key.
   *
   * <p>A non-empty {@link SetMultimap} cannot be equal to a non-empty
   * {@link google.common.collect.ListMultimap}, since their {@link #asMap} views contain unequal
   ...
   * as returned by {@link google.common.collect.Multimap#asMap}.
   */
  @Override
  int hashCode();
}
