 ...
 * {@link java.util.Map} specified by the {@link google.common.collect.Table} interface.
 *
 ...
 * java.util.SortedMap} instances, instead of the {@link java.util.Map} specified in the {@link
 * google.common.collect.Table} interface.
 *
...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
   ...
   * {@link google.common.collect.Ordering#natural()} is returned.
   */
   ...
   *
   * <p>Because a {@code TreeBasedTable} has unique sorted values for a given
   * row, this method returns a {@link java.util.SortedMap}, instead of the {@link java.util.Map}
   * specified in the {@link google.common.collect.Table} interface.
   * @since 10.0
