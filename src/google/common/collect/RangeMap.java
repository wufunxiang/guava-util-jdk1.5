...
@GwtIncompatible("NavigableMap") final class RangeMap<K extends Comparable, V>
  ...
  /**
   * Equivalent to {@link #get(Comparable) get(K)}, provided only to satisfy the {@link google.common.base.Function}
  ...
  /**
   * Associates {@code value} with every key {@linkplain google.common.collect.Range#contains contained} in {@code
   * keyRange}.
   *
  ...
  /**
   * Removes all associations to keys {@linkplain google.common.collect.Range#contains contained} in {@code
   * rangeToClear}.
   */
