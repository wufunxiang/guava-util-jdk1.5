 ...
 * allow duplicates. If the collection, such as a {@link java.util.Set}, does not support
 ...
 * java.util.List} that allow duplicates, the collection will keep the existing key-value
...
abstract class AbstractMultimap<K, V> implements Multimap<K, V>, Serializable {
   ...
   * google.common.collect.AbstractMultimap#map} whenever the delegate is non-empty. The {@code
  ...
  private class KeySet extends Maps.KeySet<K, Collection<V>> {
     ...
     * subcollection of a {@link google.common.collect.AbstractMultimap.SortedKeySet}.
     */
