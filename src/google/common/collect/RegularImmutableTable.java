...
/**
 * An implementation of {@link google.common.collect.ImmutableTable} holding an arbitrary number of
 * cells.
 *
 * @author Gregory Kick
 */
...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V> {
  ...
  static final class SparseImmutableTable<R, C, V>
    ...
    /**
     * Creates a {@link java.util.Map} over the key space with
     * {@link google.common.collect.ImmutableMap.Builder}s ready for values.
     */
