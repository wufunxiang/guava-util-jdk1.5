...
import google.common.collect.Collections2.TransformedCollection;
import google.common.collect.Table.Cell;
...
public final class Tables {
   ...
   * example, in a {@link google.common.collect.HashBasedTable} instance, {@code
   * rowKeySet().iterator()} supports {@code remove()} but {@code
   * columnKeySet().iterator()} doesn't. With a transposed {@link
   * google.common.collect.HashBasedTable}, it's the other way around.
   */
   ...
   * generate a table based on arbitrary {@link java.util.Map} classes.
   *
   ...
   * {@link google.common.collect.HashBasedTable} and {@link TreeBasedTable} won't suffice.
   *
   * <p>The views returned by the {@code Table} methods {@link google.common.collect.Table#column},
   * {@link google.common.collect.Table#columnKeySet}, and {@link google.common.collect.Table#columnMap} have iterators that
   ...
   * applied many times for bulk operations like {@link google.common.collect.Table#containsValue} and
   ...
   *
   * <p>Consider using an {@link google.common.collect.ImmutableTable}, which is guaranteed never to change.
   * 
   * @param table
