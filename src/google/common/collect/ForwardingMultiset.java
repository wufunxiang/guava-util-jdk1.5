...
public abstract class ForwardingMultiset<E> extends ForwardingCollection<E>
  ...
  /**
   * A sensible definition of {@link #addAll(java.util.Collection)} in terms of {@link
   * #add(Object)} and {@link #add(Object, int)}. If you override either of
   * these methods, you may wish to override {@link #addAll(java.util.Collection)} to
   * forward to this implementation.
   * 
   * @since 7.0
   */
   ...
   * @since 7.0
   */
  @Beta  protected boolean standardRemove(Object element) {
   ...
   * @since 7.0
   */
  @Beta  protected boolean standardRemoveAll(
   ...
   * @since 7.0
   */
  @Beta  protected boolean standardRetainAll(
   ...
   * following methods: {@link google.common.collect.ForwardingMultiset#clear}, {@link
   * google.common.collect.ForwardingMultiset#contains}, {@link google.common.collect.ForwardingMultiset#containsAll},
   * {@link google.common.collect.ForwardingMultiset#count}, {@link google.common.collect.ForwardingMultiset#isEmpty}, the
   * {@link java.util.Set#size} and {@link java.util.Set#iterator} methods of {@link
   * google.common.collect.ForwardingMultiset#entrySet}, and {@link google.common.collect.ForwardingMultiset#remove(Object,
   * int)}.  In many situations, you may wish to override {@link
   * google.common.collect.ForwardingMultiset#elementSet} to forward to this implementation or a
   * subclass thereof.
   *
   * @since 10.0
   */
