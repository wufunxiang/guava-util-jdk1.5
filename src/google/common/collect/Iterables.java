...
import google.common.base.Optional;
 ...
 * {@link java.util.Iterator}-based method in the {@link Iterators} class.
 *
...
public final class Iterables {
   ...
   * collection.
   *
   * <p>This method calls {@link java.util.Collection#removeAll} if {@code iterable} is a
   ...
   * provided collection.
   *
   * <p>This method calls {@link java.util.Collection#retainAll} if {@code iterable} is a
   ...
   * iterable is a {@link Multiset} or {@link java.util.Set}.
   *
   ...
   * java.util.Iterator#remove()} method. The returned lists implement {@link
   * java.util.RandomAccess}, whether or not the input list does.
   *
   * <p><b>Note:</b> if {@code iterable} is a {@link java.util.List}, use {@link
   * Lists#partition(java.util.List, int)} instead.
   *
   ...
   *
   * <p>Iterators returned by the returned iterable do not support the {@link
   * java.util.Iterator#remove()} method.
   *
   * @param iterable the iterable to return a partitioned view of
   ...
   * {@link #find(Iterable, google.common.base.Predicate, Object)} instead.
   *
   * @throws java.util.NoSuchElementException if no element in {@code iterable} matches
   *     the given predicate
   */
  ...
  /**
   * Returns an {@link google.common.base.Optional} containing the first element in {@code
   ...
   * google.common.collect.Collections2#transform}.
   */
   ...
   * {@link java.util.Iterator} through {@link Iterators#consumingIterator(java.util.Iterator)}.
   *
   * <p>Note: If {@code iterable} is a {@link java.util.Queue}, the returned iterable will
   * get entries from {@link java.util.Queue#remove()} since {@link java.util.Queue}'s iteration
   * order is undefined.  Calling {@link java.util.Iterator#hasNext()} on a generated
   * iterator from the returned iterable may cause an item to be immediately
   * dequeued for return on a subsequent call to {@link java.util.Iterator#next()}.
   *
   * @param iterable the iterable to wrap
   * @return a view of the supplied iterable that wraps each generated iterator
   *     through {@link Iterators#consumingIterator(java.util.Iterator)}; for queues,
   *     an iterable that generates iterators that return and consume the
   *     queue's elements in queue order
   *
   * @see Iterators#consumingIterator(java.util.Iterator)
   * @since 2.0
   */
   ...
   *
   * <p>There is no precise {@link java.util.Iterator} equivalent to this method, since
   * one can only ask an iterator whether it has any elements <i>remaining</i>
   * (which one does using {@link java.util.Iterator#hasNext}).
   *
