...
/**
 * A collection that supports order-independent equality, like {@link java.util.Set}, but
 ...
 * collapsed", and {@link #entrySet} is similar but contains {@link google.common.collect.Multiset.Entry
 ...
 * implementation.
 *
 * <p>Common implementations include {@link google.common.collect.ImmutableMultiset}, {@link
 * google.common.collect.HashMultiset}, and {@link google.common.collect.ConcurrentHashMultiset}.
 *
 * <p>If your values may be zero, negative, or outside the range of an int, you
 * may wish to use {@link google.common.util.concurrent.AtomicLongMap}
...
public interface Multiset<E> extends Collection<E> {
   ...
   * multiset, this gives the same result as {@link java.util.Collections#frequency}
   * (which would presumably perform more poorly).
   *
   * <p><b>Note:</b> the utility method {@link google.common.collect.Iterables#frequency} generalizes
   ...
   * google.common.collect.Multiset#entrySet} method returns a view of the multiset whose elements
   ...
   *
   * <p>This method refines {@link java.util.Collection#contains} to further specify that
   ...
   *
   * <p>This method refines {@link java.util.Collection#containsAll} to further specify
   ...
   * collection type like {@link java.util.List}, but it may be unexpected to the user of
   * a multiset.
   *
   ...
   *
   * <p>This method refines {@link java.util.Collection#add}, which only <i>ensures</i>
   ...
   *     multiset, unlike other {@link java.util.Collection} types
   * @throws NullPointerException if {@code element} is null and this
   ...
   * multiset, if present.
   *
   * <p>This method refines {@link java.util.Collection#remove} to further specify that it
   ...
   * in {@code c}, see {@link Multisets#removeOccurrences(google.common.collect.Multiset, google.common.collect.Multiset)}.
   * 
   * <p>This method refines {@link java.util.Collection#removeAll} to further specify that
   ...
   * {@code c}, and only cares whether or not an element appears at all.
   * If you wish to remove one occurrence in this multiset for every occurrence
   * in {@code c}, see {@link Multisets#retainOccurrences(google.common.collect.Multiset, google.common.collect.Multiset)}.
   * 
   * <p>This method refines {@link java.util.Collection#retainAll} to further specify that
   * it <b>may not</b> throw an exception in response to any of {@code elements}
   * being null or of the wrong type.
   * 
   * @see Multisets#retainOccurrences(google.common.collect.Multiset, google.common.collect.Multiset)
   */
