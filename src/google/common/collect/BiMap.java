...
public interface BiMap<K, V> extends Map<K, V> {
   ...
   * {@inheritDoc}
   *
   * <p>Because a bimap has unique values, this method returns a {@link java.util.Set},
   * instead of the {@link java.util.Collection} specified in the {@link java.util.Map}
   * interface.
   */
