...
import google.common.collect.GenericMapMaker.NullListener;
import google.common.collect.MapMaker.RemovalCause;
import google.common.collect.MapMaker.RemovalListener;
import google.common.collect.MapMaker.RemovalNotification;
...
/**
 * The concurrent hash map implementation built by {@link google.common.collect.MapMaker}.
 *
...
class MapMakerInternalMap<K, V>
  ...
  interface ValueReference<K, V> {
     ...
     *
     * @throws java.util.concurrent.ExecutionException if the computing thread throws an exception
     */
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.collect.MapMakerInternalMap.Segment#newEntry} directly.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.collect.MapMakerInternalMap.Segment#copyEntry} directly.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.collect.MapMakerInternalMap.Segment#setValue} instead.
   */
  @GuardedBy("Segment.this")
  @VisibleForTesting
  ...
  /**
   * This method is a convenience for testing. Code should call {@link google.common.collect.MapMakerInternalMap.Segment#getLiveValue}
   * instead.
   */
  @VisibleForTesting
   ...
   * partially-collected, computing, or expired. Unlike {@link google.common.collect.MapMakerInternalMap.Segment#getLiveValue} this method
  ...
  static class Segment<K, V> extends ReentrantLock {
     ...
     * google.common.collect.MapMakerInternalMap#containsValue} directly.
     */
    @VisibleForTesting
