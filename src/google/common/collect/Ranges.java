...
/**
 * Static methods pertaining to {@link google.common.collect.Range} instances.  Each of the
 * {@link google.common.collect.Range nine types of ranges} can be constructed with a corresponding
 * factory method:
 *
 * <dl>
 * <dt>{@code (a..b)}
 ...
 * </dl>
 *
 * <p>Additionally, {@link google.common.collect.Range} instances can be constructed by passing the
 * {@link google.common.collect.BoundType bound types} explicitly.
 *
 * <dl>
...
public final class Ranges {
  ...
  /**
   * Returns a range that {@linkplain google.common.collect.Range#contains(Comparable) contains} only
   * the given value. The returned range is {@linkplain google.common.collect.BoundType#CLOSED closed}
   * on both ends.
   */
   ...
   * {@linkplain google.common.collect.Range#contains(Comparable) contains} all of the given values.
   * The returned range is {@linkplain google.common.collect.BoundType#CLOSED closed} on both ends.
   *
   * @throws ClassCastException if the parameters are not <i>mutually
   *     comparable</i>
   * @throws java.util.NoSuchElementException if {@code values} is empty
