...
public abstract class ImmutableMultimap<K, V>
   ...
   * created by the {@link google.common.collect.ImmutableMultimap.Builder} constructor.
   */
  ...
  /**
   * Multimap for {@link google.common.collect.ImmutableMultimap.Builder} that maintains key and
  ...
  public static class Builder<K, V> {
     ...
     * generated by {@link google.common.collect.ImmutableMultimap#builder}.
     */
    public Builder() {}
  ...
  class Keys extends ImmutableMultiset<K> {
    ...
    private class KeysEntrySet extends ImmutableMultiset<K>.EntrySet {
      ...
      ImmutableList<Entry<K>> createAsList() {
        final ImmutableList<? extends java.util.Map.Entry<K, ? extends Collection<V>>> mapEntries =
            map.entrySet().asList();
        return new ImmutableAsList<Entry<K>>() {
          
          public Entry<K> get(int index) {
        	  java.util.Map.Entry<K, ? extends Collection<V>> entry = mapEntries.get(index);
