...
import static google.common.base.Preconditions.checkElementIndex;
import static google.common.base.Preconditions.checkNotNull;
import static google.common.base.Preconditions.checkPositionIndex;
...
public final class Lists {
   ...
   * google.common.collect.ImmutableList#of()} instead.
   *
   ...
   * non-null, use an overload of {@link google.common.collect.ImmutableList#of()} (for varargs) or
   * {@link google.common.collect.ImmutableList#copyOf(Object[])} (for an array) instead.
   *
   ...
   *
   * <p><b>Note:</b> if mutability is not required and the elements are
   * non-null, use {@link google.common.collect.ImmutableList#copyOf(java.util.Iterator)} instead.
   *
   * @param elements the elements that the list should contain, in order
   * @return a new {@code ArrayList} containing those elements
   */
   ...
   * google.common.collect.ImmutableList} instead of a growable {@link java.util.ArrayList}.
   *
   ...
   *
   * <p><b>Note:</b> if you need an immutable empty {@link java.util.List}, use
   * {@link google.common.collect.ImmutableList#of()} instead.
   *
   ...
   * java.util.Arrays#asList}, the returned list is unmodifiable.
   *
   ...
   *
   * <p>The returned list is serializable and implements {@link java.util.RandomAccess}.
   *
  ...
  /** @see google.common.collect.Lists#asList(Object, Object[]) */
   ...
   * {@link java.util.Arrays#asList}, the returned list is unmodifiable.
   *
   * <p>This is useful when a varargs method needs to use a signature such as
  ...
  /** @see google.common.collect.Lists#asList(Object, Object, Object[]) */
   ...
   * applied many times for bulk operations like {@link java.util.List#contains} and
   * {@link java.util.List#hashCode}. For this to perform well, {@code function} should be
   * fast. To avoid lazy evaluation when the returned list doesn't need to be a
   * view, copy the returned list into a new list of your choosing.
   *
   * <p>If {@code fromList} implements {@link java.util.RandomAccess}, so will the
   ...
   * {@link google.common.collect.Collections2#transform} or {@link google.common.collect.Iterables#transform}.
   *
   ...
   * copy the list using {@link google.common.collect.ImmutableList#copyOf(java.util.Collection)} (for example),
   ...
   *
   * @see google.common.collect.Lists#transform
   */
  ...
  /**
   * Returns consecutive {@linkplain java.util.List#subList(int, int) sublists} of a list,
   ...
   * produced on demand using {@link java.util.List#subList(int, int)}, and are subject
  ...
  /**
   * An implementation of {@link java.util.List#hashCode()}.
   */
  ...
  /**
   * An implementation of {@link java.util.List#equals(Object)}.
   */
  ...
  /**
   * An implementation of {@link java.util.List#addAll(int, java.util.Collection)}.
   */
  ...
  /**
   * An implementation of {@link java.util.List#indexOf(Object)}.
   */
  ...
  /**
   * An implementation of {@link java.util.List#lastIndexOf(Object)}.
   */
  ...
  /**
   * Returns an implementation of {@link java.util.List#listIterator(int)}.
   */
  ...
  /**
   * An implementation of {@link java.util.List#subList(int, int)}.
   */
