...
import static google.common.collect.Maps.keyOrNull;
...
public abstract class ForwardingNavigableMap<K, V>
  ...
  /**
   * A sensible implementation of {@link java.util.NavigableMap#descendingMap} in terms of the methods of
   * this {@code NavigableMap}. In many cases, you may wish to override
   * {@link google.common.collect.ForwardingNavigableMap#descendingMap} to forward to this implementation or a subclass
   * thereof.
   *
   * <p>In particular, this map iterates over entries with repeated calls to
   * {@link java.util.NavigableMap#lowerEntry}. If a more efficient means of iteration is available, you may
  ...
  /**
   * A sensible implementation of {@link java.util.NavigableMap#navigableKeySet} in terms of the methods of
   * this {@code NavigableMap}. In many cases, you may wish to override
   * {@link google.common.collect.ForwardingNavigableMap#navigableKeySet} to forward to this implementation or a subclass
   * thereof.
   *
   * @since 12.0
   */
   ...
   * {@link #descendingMap}. (The {@link google.common.collect.ForwardingNavigableMap.StandardDescendingMap} implementation implements
