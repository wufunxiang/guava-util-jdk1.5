...
public abstract class FluentIterable<E> implements Iterable<E> {
  ...
  /**
   * Returns an {@link google.common.base.Optional} containing the first element in this fluent iterable that
  ...
  /**
   * Returns an {@link google.common.base.Optional} containing the first element in this fluent iterable.
  ...
  /**
   * Returns an {@link google.common.base.Optional} containing the last element in this fluent iterable.
   * If the iterable is empty, {@code Optional.absent()} is returned.
   *
