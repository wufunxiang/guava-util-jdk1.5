...
import google.common.hash.BloomFilterStrategies.BitArray;
...
public final class BloomFilter<T> implements Serializable {
  ...
  /**
   * Creates a {@code Builder} of a {@link google.common.hash.BloomFilter BloomFilter<T>}, with the expected number
