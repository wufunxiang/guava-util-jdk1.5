...
import google.common.primitives.UnsignedInts;

import java.nio.ByteBuffer;
import java.util.Iterator;

/**
 * Static methods to obtain {@link google.common.hash.HashFunction} instances, and other static
...
public final class Hashing {
   ...
   * return {@link google.common.hash.HashFunction} instances with identical behavior (but not necessarily the
