...
package google.common.math;

import static google.common.base.Preconditions.checkArgument;
import static google.common.base.Preconditions.checkNotNull;
import static google.common.math.MathPreconditions.checkNoOverflow;
import static google.common.math.MathPreconditions.checkNonNegative;
import static google.common.math.MathPreconditions.checkPositive;
import static google.common.math.MathPreconditions.checkRoundingUnnecessary;
 ...
 *
 * <p>Similar functionality for {@code int} and for {@link java.math.BigInteger} can be found in
 * {@link google.common.math.IntMath} and {@link google.common.math.BigIntegerMath} respectively.  For other common operations on
 * {@code long} values, see {@link google.common.primitives.Longs}.
 *
...
public final class LongMath {
   ...
   * @throws ArithmeticException if {@code mode} is {@link java.math.RoundingMode#UNNECESSARY} and {@code x}
   ...
   *
   * @throws IllegalArgumentException if {@code x < 0}
   * @throws ArithmeticException if {@code mode} is {@link java.math.RoundingMode#UNNECESSARY} and
