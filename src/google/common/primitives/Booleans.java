 ...
 * already found in either {@link Boolean} or {@link java.util.Arrays}.
 *
...
public final class Booleans {
   ...
   * {@code array}.
   *
   * <p><b>Note:</b> consider representing the array as a {@link java.util.BitSet}
   * instead, and using {@link java.util.BitSet#nextSetBit(int)} or {@link
   ...
   * it is consistent with {@link java.util.Arrays#equals(boolean[], boolean[])}.
   *
