 ...
 * {@code 2^64 + x}). The methods for which signedness is not an issue are in {@link google.common.primitives.Longs}, as
 ...
 * {@code long} values. When possible, it is recommended that the {@link google.common.primitives.UnsignedLong} wrapper
