...
package google.common.eventbus;
...
import google.common.cache.CacheLoader;
import google.common.cache.LoadingCache;
import google.common.collect.Multimap;
import google.common.collect.Multimaps;
import google.common.collect.SetMultimap;
import google.common.reflect.TypeToken;
 ...
 * later.  (For a convenient way to do this, use an {@link google.common.eventbus.AsyncEventBus}.)
 *
 ...
 * bearing the {@link google.common.eventbus.AllowConcurrentEvents} annotation.  If this annotation is
 ...
 * they are wrapped in an instance of {@link google.common.eventbus.DeadEvent} and reposted.
 *
...
public class EventBus {
   ...
   * only the {@link google.common.eventbus.AnnotatedHandlerFinder} is supported, but this is
   ...
   * {@link google.common.eventbus.AnnotatedHandlerFinder}.
   *
   ...
   * {@code event} is not already a {@link google.common.eventbus.DeadEvent}, it will be wrapped in a
