 ...
 * Note that even though these methods use {@link java.net.URL} parameters, they
...
public final class Resources {
  ...
  /**
   * Returns a factory that will supply instances of {@link java.io.InputStream} that
   ...
   * {@link java.io.InputStreamReader} that read a URL using the given character set.
   *
   * @param url the URL to read from
