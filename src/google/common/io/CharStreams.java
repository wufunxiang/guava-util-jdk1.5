...
public final class CharStreams {
  ...
  /**
   * Returns a factory that will supply instances of {@link java.io.StringReader} that
   * read a string value.
   *
  ...
  /**
   * Returns a factory that will supply instances of {@link java.io.InputStreamReader},
   * using the given {@link java.io.InputStream} factory and character set.
   *
   ...
   * using the given {@link java.io.OutputStream} factory and character set.
   *
  ...
  /**
   * Returns the characters from a {@link Readable} & {@link java.io.Closeable} object
  ...
  /**
   * Reads the first line from a {@link Readable} & {@link java.io.Closeable} object
  ...
  /**
   * Reads all of the lines from a {@link Readable} & {@link java.io.Closeable} object
  ...
  /**
   * Streams lines from a {@link Readable} and {@link java.io.Closeable} object
  ...
  /**
   * Joins multiple {@link java.io.Reader} suppliers into a single supplier.
   ...
   * java.io.Closeable}, and flushing the writer will flush the target if it is {@link
   * java.io.Flushable}.
   *
