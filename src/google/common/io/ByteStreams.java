...
public final class ByteStreams {
   ...
   * {@link java.io.ByteArrayInputStream} that read from the given byte array.
   *
  ...
  /**
   * Returns the data from a {@link java.io.InputStream} factory as a byte array.
   *
  ...
  /**
   * Returns a new {@link google.common.io.ByteArrayDataInput} instance to read from the {@code
  ...
  /**
   * Returns a new {@link google.common.io.ByteArrayDataOutput} instance with a default size.
   */
  ...
  /**
   * Returns a new {@link google.common.io.ByteArrayDataOutput} instance sized to hold
   ...
   * @return the {@link google.common.hash.HashCode} of all of the bytes in the input stream
   * @throws java.io.IOException if an I/O error occurs
   * @since 12.0
   */
  ...
  /**
   * Joins multiple {@link java.io.InputStream} suppliers into a single supplier.
