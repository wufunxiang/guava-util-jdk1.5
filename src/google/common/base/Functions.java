...
public final class Functions {
   ...
   * documented at {@link google.common.base.Function#apply}). For example, this function yields different results for
   ...
   * google.common.base.Function#apply}) if and only if {@code predicate} is itself consistent with equals.
   */
  public static <T> Function<T, Boolean> forPredicate(Predicate<T> predicate) {
    return new PredicateFunction<T>(predicate);
  }

  /** @see google.common.base.Functions#forPredicate */
  ...
  /** @see google.common.base.Functions#forSupplier*/
