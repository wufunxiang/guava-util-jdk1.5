...
public class Joiner {
   ...
   *
   * @since 11.0
   * @deprecated use {@link #appendTo(Appendable, java.util.Iterator)} by casting {@code parts} to
   ...
   *
   * @since 11.0
   * @deprecated use {@link #appendTo(StringBuilder, java.util.Iterator)} by casting {@code parts} to
   *     {@code Iterator<?>}, or better yet, by implementing only {@code Iterator} and not
   *     {@code Iterable}. <b>This method is scheduled for deletion in June 2013.</b>
   */
  @Beta
   ...
   *
   * @since 11.0
   * @deprecated use {@link #join(java.util.Iterator)} by casting {@code parts} to
   *     {@code Iterator<?>}, or better yet, by implementing only {@code Iterator} and not
   *     {@code Iterable}. <b>This method is scheduled for deletion in June 2013.</b>
   */
  @Beta
  ...
  public final static class MapJoiner {
     ...
     * #appendTo(Appendable, java.util.Map)}, except that it does not throw {@link java.io.IOException}.
     */
     ...
     *
     * @since 11.0
     * @deprecated use {@link #appendTo(Appendable, java.util.Iterator)} by casting {@code entries} to
     ...
     *
     * @since 11.0
     * @deprecated use {@link #appendTo(StringBuilder, java.util.Iterator)} by casting {@code entries} to
     *     {@code Iterator<? extends Entry<?, ?>>}, or better yet, by implementing only
     *     {@code Iterator} and not {@code Iterable}. <b>This method is scheduled for deletion
     *     in June 2013.</b>
     */
     ...
     * Appends the string representation of each entry in {@code entries}, using the previously
     * configured separator and key-value separator, to {@code builder}. Identical to {@link
     * #appendTo(Appendable, Iterable)}, except that it does not throw {@link java.io.IOException}.
     *
     * @since 10.0
     */
    @Beta
     ...
     *
     * @since 11.0
     * @deprecated use {@link #join(java.util.Iterator)} by casting {@code entries} to
     *     {@code Iterator<? extends Entry<?, ?>>}, or better yet, by implementing only
     *     {@code Iterator} and not {@code Iterable}. <b>This method is scheduled for deletion
     *     in June 2013.</b>
     */
