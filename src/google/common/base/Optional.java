...
public abstract class Optional<T> implements Serializable {
   ...
   * reference; otherwise returns {@link google.common.base.Optional#absent}.
   */
  ...
  /**
   * If the instance is present, it is transformed with the given {@link google.common.base.Function}; otherwise,
   * {@link google.common.base.Optional#absent} is returned. If the function returns {@code null}, a
   ...
   * skipping over occurrences of {@link google.common.base.Optional#absent}. Iterators are unmodifiable and are
   * evaluated lazily.
   *
